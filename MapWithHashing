...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final Pair<K, V> remove(K key) {
        ...
        Pair<K, V> returnPair = this.hashTable.entry(bucketNumber).remove(key);
    ...
    public final V value(K key) {
        ...
        return this.hashTable.entry(bucketNumber).value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        boolean returnValue = this.hashTable.entry(bucketNumber).hasKey(key);
        return returnValue;
    }
    ...
    public final int size() {
        ...
        for (int i = 0; i < this.hashTable.length(); i++) {
            returnValue += this.hashTable.entry(i).size();
        }
